...
Discrete Choice Modeling 至少得有两个equations
...
# 上面的结果导致Choice变成了True/False, 并且新增了一个alt (代表原来的"choice") <-- 用mlogit的前提是需要把变量的名字都code整齐(变量里最后要用.alternative结尾)
